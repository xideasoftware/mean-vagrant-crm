...
angular.module('wain013', ['ngSanitize', 'ui.select', 'summernote', 'ngDropzone', 'daterangepicker'])
    .controller('UsersListCtrl', ['$scope', 'BusinessService', 'UserService', 'ipCookie', '$rootScope', function($scope, BusinessService, UserService,ipCookie,$rootScope) {
